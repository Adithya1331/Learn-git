...
|**table**|_goes_|here|
|:---:|:---|---:|
in this table if i want text alignment i use colon|how are you doing this| i'm here
...
<details>
<summary>
click this for whole content
</summary>
- _here the total summary_
</details>
